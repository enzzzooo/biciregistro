...
function getMockBicycles(filters: SearchFilters): Bicycle[] {
  const allBicycles: Bicycle[] = [
    ...
    },
    {
      ...
      numeroMatricula: 'MAL-025',
      fechaRobo: '2024-02-18',
      lugarRobo: 'Calle Larios',
      ciudad: 'Málaga',
      provincia: 'Málaga',
      descripcion: 'MTB de doble suspensión, muy ligera',
      imagen: 'https://images.unsplash.com/photo-1559316662-d0e8e4266c85?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1559316662-d0e8e4266c85?w=1200',
      estado: 'localizada',
      fechaLocalizacion: '2024-03-10',
      lugarLocalizacion: 'Puerto de Málaga',
    },
    {
      id: '8',
      marca: 'Merida',
      modelo: 'Crossway 100',
      color: 'Naranja',
      numeroSerie: 'MER778899',
      numeroMatricula: 'GRA-031',
      fechaRobo: '2024-01-22',
      lugarRobo: 'Gran Vía de Colón',
      ciudad: 'Granada',
      provincia: 'Granada',
      descripcion: 'Bicicleta de trekking con portaequipajes',
      imagen: 'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=1200',
      estado: 'localizada',
      fechaLocalizacion: '2024-02-28',
      lugarLocalizacion: 'Alhambra',
    },
    {
      id: '9',
      marca: 'Cube',
      modelo: 'Attention SL',
      color: 'Plateado',
      numeroSerie: 'CUB112233',
      numeroMatricula: 'MUR-017',
      fechaRobo: '2024-03-08',
      lugarRobo: 'Avenida de la Libertad',
      ciudad: 'Murcia',
      provincia: 'Murcia',
      descripcion: 'MTB hardtail con frenos hidráulicos',
      imagen: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200',
      estado: 'localizada',
      fechaLocalizacion: '2024-03-22',
      lugarLocalizacion: 'Jardín de Floridablanca',
    },
    {
      id: '10',
      marca: 'Lapierre',
      modelo: 'Sensium AL 200',
      color: 'Morado',
      numeroSerie: 'LAP334455',
      numeroMatricula: 'ALC-022',
      fechaRobo: '2024-02-05',
      lugarRobo: 'Explanada de España',
      ciudad: 'Alicante',
      provincia: 'Alicante',
      descripcion: 'Bicicleta de carretera de aluminio',
      imagen: 'https://images.unsplash.com/photo-1532298229144-0ec0c57515c7?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1532298229144-0ec0c57515c7?w=1200',
      estado: 'localizada',
    ...
    },
    {
      id: '11',
      marca: 'Mondraker',
      modelo: 'Chrono Carbon',
      color: 'Negro/Rojo',
      numeroSerie: 'MON556677',
      numeroMatricula: 'VIT-013',
      fechaRobo: '2024-01-18',
      lugarRobo: 'Calle Dato',
      ciudad: 'Vitoria',
      provincia: 'Álava',
      descripcion: 'Bicicleta de carretera de fibra de carbono',
      imagen: 'https://images.unsplash.com/photo-1571333250630-f0230c320b6d?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1571333250630-f0230c320b6d?w=1200',
      estado: 'localizada',
      fechaLocalizacion: '2024-02-18',
      lugarLocalizacion: 'Parque de la Florida',
    },
    {
      id: '12',
      marca: 'Bianchi',
      modelo: 'Via Nirone 7',
      color: 'Celeste',
      numeroSerie: 'BIA667788',
      numeroMatricula: 'SAN-028',
      fechaRobo: '2024-02-12',
      lugarRobo: 'Avenida de la Constitución',
      ciudad: 'Santander',
      provincia: 'Cantabria',
      descripcion: 'Bicicleta de carretera clásica italiana',
      imagen: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=400',
      imagenCompleta: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=1200',
      estado: 'localizada',
      fechaLocalizacion: '2024-03-12',
      lugarLocalizacion: 'Paseo de Pereda',
    },
  ];
